...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in ateenv/v1alpha/env_pb2_grpc.py depends on'
...
def add_EnvironmentServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('ateenv.v1alpha.EnvironmentService', rpc_method_handlers)
